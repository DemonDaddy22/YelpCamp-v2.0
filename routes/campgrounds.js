...
const { validateCampground, isLoggedIn } = require('../utils/middleware');
...
router.post('/', isLoggedIn, validateCampground, asyncErrorHandler(async (req, res, next) => {
...
router.patch('/:id', isLoggedIn, validateCampground, asyncErrorHandler(async (req, res) => {
    const { id } = req.params;
